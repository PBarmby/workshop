...
#outcube = OutHDFQuadCube('/data/sitelle/orb/17BQ06/17BF17/M33-NW_SN3.merged.cm1.1.0_modif.hdf5', cube.shape, cube.config.QUAD_NB)
...
#cube = SpectralCube('/data/sitelle/orb/17BQ06/17BF17/M33-NW_SN3.merged.cm1.1.0_modif.hdf5')
...
#axis, sky = cube.extract_spectrum(1866,963,50)
#sky = sky/(3.14159*50*50)
#outcube = OutHDFQuadCube('/data/sitelle/orb/17BQ06/17BF17/M33-NW_SN2.merged.cm1.1.0_modif.hdf5', cube.shape, cube.config.QUAD_NB)
...
#cube = SpectralCube('/data/sitelle/orb/17BQ06/17BF17/M33-NW_SN2.merged.cm1.1.0_modif.hdf5')
...
#axis, sky = cube.extract_spectrum(1866,963,50)
#sky = sky/(3.14159*50*50)
#outcube = OutHDFQuadCube('/data/sitelle/orb/17BQ06/17BF17/M33-NW_SN1.merged.cm1.1.0_modif.hdf5', cube.shape, cube.config.QUAD_NB)
